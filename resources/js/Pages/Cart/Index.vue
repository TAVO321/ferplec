...
<template>
    <Publico>
        <div class="pantalla py-10">
            ...
            <div v-if="cart.items.value.length" class="mt-8 grid gap-8 lg:grid-cols-[1fr_320px]">
                <div class="space-y-3">
                    <div v-for="item in cart.items.value" :key="item.producto_id" class="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-4 sm:flex-row sm:items-center">
                        ...
                        <div class="flex items-center justify-between gap-3 sm:justify-end">
                            ...
                            <Moneda :valor="(item.precio * item.cantidad).toFixed(2)" clase="w-24 text-right text-sm font-bold text-slate-900" />
            ...
            <div v-else class="mt-8 rounded-2xl border border-dashed border-slate-300 bg-white py-20 text-center">
                ...
                <p class="mt-1 text-sm text-slate-500">Agrega productos del catalogo para poder apartarlos.</p>
